...
from geoips.pydantic_models.v1.bases import FrozenModel, PluginModel, PythonIdentifier
from geoips.pydantic_models.v1.workflows import WorkflowStepDefinitionModel
...
class ControllerConfigSpec(FrozenModel):
    ...
    data_monitor: DataMonitor = Field(
        ...,
        description="The data monitor plugin to use with your controller.",
    )
    cadence: str = Field(
        ...,
        description=(
