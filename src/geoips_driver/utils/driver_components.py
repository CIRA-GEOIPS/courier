...
class ProcessSpawner(Templater, FileOperator):
    ...
    def run_temp_script(
        ...
        """
        Write script_text to a temporary .sh file, make it executable, run it, and delete.

        Deletion of the file is done after it has completed.

        Parameters
        ----------
        script_text: str
            - The exact text of the bash script to execute.
        timeout: float | None
            - An optional timeout in seconds.
        capture_output: bool | False
            - Whether or not to capture the output of the bash script to be executed.
