...
class ServiceConfig:
    ...
    database_url: str = field(
        default_factory=lambda: os.environ.get(
            "DATABASE_URL",
            "postgresql://admin:admin@localhost:5432/lazylemon",
        ),
    )
...
class ServicePlugin(Protocol):
    ...
    Examples
    --------
    >>> from lazylemon.interfaces.module_based.logging import get_logger
    >>> class MyPlugin:
    ...     name = "my-plugin"
    ...     version = "1.0.0"
...
def parse_driver_args() -> Any:
    ...
    provided by the lazylemon module.
    """
    # This should be imported from lazylemon
    pass
