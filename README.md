...
Courier is a plugin-based, event-driven orchestration framework for building data processing pipelines. It watches for incoming data, groups it into jobs, and dispatches those jobs to processing workflows. It is designed to scale from a single machine to a distributed cluster without changes to pipeline code or configuration.
