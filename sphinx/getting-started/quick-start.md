...
2.  Extracts metadata (platform, sensor, sector, timestamp)
3.  Groups files into processing jobs
4.  Executes a simple processing script for each job
    ...
    spec:
      ...
      run:
        ...
        - watch_files:
            ...
            config:
              path: /home/youruser/goes18_data/incoming
              metadata-tools:
        ...
        - process_data:
            ...
            config:
              bash_script: |
                ...
                # Move processed file
                mv {file} /home/youruser/goes18_data/processed/
...
**Metadata Section:**
    ...
    apiVersion: geoips_driver/v1  # API version
...
Run your service:
    ...
    If using poetry
    ===============
    poetry run python -m geoips_driver.dummy_cli run goes18_watcher.yaml
...
You should see output like:
    ...
    [Plugin: file_system_poller_watchdog] Starting to watch directory: /home/youruser/goes18_data/incoming
...
Watch the service logs. You should see:
    ...
    [Plugin: file_system_poller_watchdog] Found file: File(file=/home/youruser/goes18_data/incoming/OR_ABI-L1b-RadF-M6C01_G18_s20240151200000_e20240151209310_c20240151209360.nc, platform=goes18, sensor=abi, sector=Full-Disk, timestamp=2024-01-15 12:00:00)
    [Plugin: DummyJobBuilder] Received file from file queue
    [Plugin: serial_bash] Executing job
    ==========================================
    Processing file: /home/youruser/goes18_data/incoming/OR_ABI-L1b-RadF-M6C01_G18_s20240151200000_e20240151209310_c20240151209360.nc
...
-   Verify configuration syntax:
    `poetry run python -m geoips_driver.dummy_cli validate goes18_watcher.yaml`
...
-   Ask questions in \`GitHub Discussions
    \](<https://github.com/biosafetylvl5/geoips_driver/discussions>)
